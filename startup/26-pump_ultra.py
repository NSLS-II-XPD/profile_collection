...
class syrng_ultra(Device):
    ...
    read_target_vol_unit = Cpt(
        EpicsSignalRO, "TVOLUMEUNITS:RBV", string=True, kind="config"
    )
    ...
    read_infuse_rate_unit = Cpt(
        EpicsSignalRO, "IRATEUNITS:RBV", string=True, kind="hinted"
    )
    read_withdraw_rate = Cpt(EpicsSignalRO, "WRATE:RBV", kind="hinted")
    read_withdraw_rate_unit = Cpt(
        EpicsSignalRO, "WRATEUNITS:RBV", string=True, kind="hinted"
    )
    ...
    def check_pump_condition(self, input_size, syringe_material, wait=False):
        ...
        print(
            "There is no way to double check the rate range if the syrnge size/material is not correct.\n"
        )
        ...
        print(
            "Cmmunication: " + f"{self.communication.get()} @ {self.update_pump.get()}"
        )
        print(
            "Target Volume: "
...
ultra1 = syrng_ultra(
    "XF:28IDC-ES:1{Pump:Syrng-Ultra:1}:",
    name="Pump_Ultra1",
    read_attrs=[
        "status",
        "communication",
        "update_pump",
        "read_target_vol",
        "read_target_vol_unit",
        "read_infused",
        "read_infused_unit",
        "read_withdrawn",
        "read_withdrawn_unit",
        "read_infuse_rate",
        "read_infuse_rate_unit",
        "read_withdraw_rate",
        "read_withdraw_rate_unit",
    ],
)

ultra2 = syrng_ultra(
    "XF:28IDC-ES:1{Pump:Syrng-Ultra:2}:",
    name="Pump_Ultra2",
    read_attrs=[
        "status",
        "communication",
