...
import numpy as np
# from 32-data_export import _readable_time
# import 31-data_analysis as da
...
class multipeak_fitting(open_subfigures):
    ...
    def plot_fitting(self, x, y, popt_list, single_f, fill_between=True, num_var=3):
        for i in range(len(popt_list)):
            ...
            r_2 = r_square(x, y, fitted_y, y_low_limit=500)
            r2 = f'R\u00b2={r_2:.2f}'
