...
cs700 = CS700TemperatureController("XF:28IDC-ES:1{Env:01}", name="cs700", settle_time=0)
cs700.done_value = 0
...
# To allow for sample temperature equilibration time, increase
# the `settle_time` parameter (units: seconds).
linkam_furnace = LinkamFurnace(
    "XF:28IDC-ES:2:{LINKAM}:", name="linkam_furnace", settle_time=0
)
