...
# # DLM
dlm_c1_bnd_bi = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:1-Ax:BndBI}Mtr", name="dlm_c1_bnd_bi"
)
dlm_c1_bnd_bo = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:1-Ax:BndBO}Mtr", name="dlm_c1_bnd_bo"
)
dlm_c1_bnd_ti = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:1-Ax:BndTI}Mtr", name="dlm_c1_bnd_ti"
)
dlm_c1_bnd_to = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:1-Ax:BndTO}Mtr", name="dlm_c1_bnd_to"
)
...
dlm_c2_bnd_bi = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:2-Ax:BndBI}Mtr", name="dlm_c2_bnd_bi"
)
dlm_c2_bnd_bo = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:2-Ax:BndBO}Mtr", name="dlm_c2_bnd_bo"
)
dlm_c2_bnd_ti = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:2-Ax:BndTI}Mtr", name="dlm_c2_bnd_ti"
)
dlm_c2_bnd_to = EpicsMotor(
    "XF:28IDA-OP:1{Mono:DLM-C:2-Ax:BndTO}Mtr", name="dlm_c2_bnd_to"
)
